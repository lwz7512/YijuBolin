...
public class DatabaseHelper  extends OrmLiteSqliteOpenHelper {
    ...
    private RuntimeExceptionDao<Favorite, Integer> favoritessRuntimeDao = null;
     ...
     */
    public RuntimeExceptionDao<Favorite, Integer> getFavoriteExceptionDao() {
        if (favoritessRuntimeDao == null) {
            favoritessRuntimeDao = getRuntimeExceptionDao(Favorite.class);
        }
        return favoritessRuntimeDao;
    }
